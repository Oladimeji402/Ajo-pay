              ...
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button key={i} className={`flex items-center gap-2.5 p-3.5 rounded-xl border-2 transition-all ${ch.active ? 'border-brand-emerald bg-emerald-50/50' : 'border-slate-100 hover:border-slate-200'
                      }`}>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
              ...
              <div className="space-y-1">
                {[
                  ...
                  <button key={i} className={`w-full flex items-center justify-between p-3.5 rounded-xl transition-all text-left ${item.danger ? 'hover:bg-red-50' : 'hover:bg-slate-50'
                    }`}>
                    <div>
