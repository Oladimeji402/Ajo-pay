  ...
  if (selectedActivity) {
    return (
      <div className="max-w-lg mx-auto">
        ...
        >
          {/* Header */}
          <div className={`p-8 text-center ${selectedActivity.type === 'contribution'
        ...
        <div className="flex gap-1 p-1 bg-white border border-slate-100 rounded-2xl shadow-sm">
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-[12px] font-bold transition-all ${activeFilter === filter.key
              ...
              {filteredActivities.map((activity, index) => (
                ...
                >
                  <div className="flex items-center gap-3.5">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-colors ${activity.type === 'contribution'
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <span className="w-0.5 h-0.5 bg-slate-300 rounded-full"></span>
                        <span className={`text-[10px] font-bold uppercase tracking-wider ${activity.type === 'contribution' ? 'text-brand-primary' : 'text-brand-emerald'
                          }`}>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <p className={`text-[13px] font-bold ${activity.type === 'contribution' ? 'text-brand-navy' : 'text-brand-emerald'
                        }`}>
